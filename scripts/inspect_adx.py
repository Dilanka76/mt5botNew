...
def main() -> None:
    ...
    connector.connect()
    try:
        # get_ohlc_range() itself now applies the MT5-vs-true-UTC offset
        # correction internally (bot/data/market_data.py) — always deal in
        # true UTC here, nothing extra to do at this call site.
